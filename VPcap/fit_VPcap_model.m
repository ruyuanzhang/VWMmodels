function [fitpars, neglh, neglhtrial, AIC, AICc, BIC] = fit_VPcap_model(N, probe, resp, x0, opt)
...
gvar.n_par          = 5;                     % number of parameters (J1bar, power, tau, kappa_r, K)
...
[x,fval,exitflag,output,optimState,gpstruct] = bads(@(params) compute_LLH_VPcap(params, data, gvar),x0,LB,UB,PLB,PUB);
