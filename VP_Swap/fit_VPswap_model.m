function [fitpars, neglh, neglhtrial, AIC, AICc, BIC] = fit_VPswap_model(N,probe,nt,resp,x0, opt)
...
gvar.n_par          = 5;                     % number of parameters (J1bar, power, tau, kappa_r, s)
...
[x,fval,exitflag,output,optimState,gpstruct] = bads(@(params) compute_LLH_VPswap(params, data, gvar),x0,LB,UB,PLB,PUB);
