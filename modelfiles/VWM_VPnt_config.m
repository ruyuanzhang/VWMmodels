...
opt.PLB = [0, 0, 0, 0, 0];
opt.PUB = [maxJ1bar, 10, maxJ1bar, maxJ1bar, 1];
opt.LB = [0, 0, 0, 0, 0];
opt.UB = [maxJ1bar, 20, maxJ1bar, maxJ1bar, 1];
opt.paramLabels = {'J1bar', 'power', 'tau', 'kappa_r', 'pNT'};
...
c.fitFun = @VWM_VPnt_fit;

%% define negative loglikelihood function
c.negLogLikeliFun=@VWM_VPnt_nll;
